...
**Estado:** Versión inicial (base documental y estructural)
...
- 📄 Creación de archivos de atribución y control:
  ...
  - `.gitignore` — Exclusión de archivos locales (ej. `General.txt`).
...
Define el estándar documental y técnico para futuras expansiones.
...
## 🧩 v1.1.0 — Controlled Expansion *(Planeada: Q1 2026)*

**Estado:** En preparación  

### Cambios previstos:
- Desarrollo de PoC funcionales por nivel.
- Incorporación de diagramas técnicos (`assets/images/`).
- Actualización de documentación de implementación.
- Inclusión de resultados de pruebas locales (Laragon, Nginx, Apache).
- Revisión técnica para futura integración OWASP.
