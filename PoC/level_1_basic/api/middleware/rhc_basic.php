...
/**
 * ==========================================================
 *  RHC BASIC MIDDLEWARE — RHC Protocol Core
 *  ----------------------------------------------------------
 *  Implementación del Protocolo RHC (Randomized Header Channel) NIVEL BASICO
 *  en entorno servidor PHP.
 * 
 *  Clase middleware estática para el protocolo RHC y su validación de nivel básico.
 * 
 *  Esta clase implementa la lógica del **Nivel 1 (Básico)** del Protocolo RHC.
 ...
 * 
 *  @file        api/middleware/rhc_basic.php
 * 
 *  @project    RHC Protocol Core
 *  @implementation Nivel 1 — Básico
 *  @usedby     PHP — Ejemplo de uso:
 * 
 *              use Middleware\RHC\RHC_Basic;
 *              $selectedHeaders = RHC_Basic::validate();
 * 
 ...
 */
	...
	/**
	 * ==========================================================
	 *  RHC_Basic — Protocolo RHC Nivel 1 — Básico
	 *  ----------------------------------------------------------
	 *  Middleware de validación de encabezados en modo:
	 *  Randomized Header Channel (Nivel 1 — Básico).
	 * 
	...
	class RHC_Basic {
		...
		/**
		 * Ejecuta la validación del canal RHC (Nivel 1 — Básico).
		 *
		 * Regla:
