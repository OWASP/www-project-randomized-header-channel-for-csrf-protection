 ...
 *  NIVEL BASICO utilizando el operador "spread" (...) para fusionar
 ...
 *  @integration RHC Basic Module (rhc_basic.js)
 *               Usa la función rhc_selectHeader_Basic() para incorporar
 *               encabezados dinámicos generados por el Protocolo RHC
 *               (Randomized Header Channel) NIVEL BASICO.
 ...
 */
	...
	function enviarPeticion(tipo) {
		...
		// Protocolo RHC (Randomized Header Channel) NIVEL BASICO.
		const headersDispersos = rhc_selectHeader_Basic(poolHT);
		...
		const headersFinales = {
			...headersDispersos, // ← Implementación del Protocolo RHC (Randomized Header Channel) NIVEL BASICO
