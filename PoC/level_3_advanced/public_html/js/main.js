 ...
 */
	...
	const apiURL = ["localhost", "127.0.0.1"].includes(hostname)
		? "https://localhost/www-project-randomized-header-channel-for-csrf-protection/PoC/level_3_advanced/api/"
		: hostname === "www.www-project-randomized-header-channel-for-csrf-protection.test"
			? "https://www.www-project-randomized-header-channel-for-csrf-protection.test/PoC/level_3_advanced/api/"
			: "";
	...
	window.onload = function() {
		...
		userLogin(headersDefinidos, 'custom', [12, 4, 8]).then(pool => {
			poolHT = pool;
