 ...
 */
	...
	// Incluir RHC (Randomized Header Channel) Nivel 3 — Aavanzado
	require_once __DIR__ . '/middleware/rhc_advanced.php';

	// Importar la clase principal del middleware RHC
	use Middleware\RHC\RHC_Advanced;

	// Crear una instancia del middleware RHC Nivel 3
	$rhc = new RHC_Advanced(
