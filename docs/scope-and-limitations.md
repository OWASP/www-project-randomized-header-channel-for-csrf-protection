...
### 3.4 Impacto en herramientas de prueba y automatización  

El uso de RHC tiene implicaciones directas sobre herramientas de testing, depuración y automatización. Este comportamiento es una consecuencia de las propiedades de seguridad del protocolo y no constituye una limitación técnica.  

Para un análisis completo, consultar [`docs/security-properties.md`](./security-properties.md) — específicamente las propiedades **Asymmetric Observability** y **Automation Resistance**.  
